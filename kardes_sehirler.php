...
$page_name = "kardes-sehirler";


$dbHandler = new DBHandler($pdo);
$kardes_sehirler_ic = $dbHandler->getKardesSehirler(1);
$kardes_sehirler_dis = $dbHandler->getKardesSehirler(0);
...
include 'views/kardes_sehirler.view.php';