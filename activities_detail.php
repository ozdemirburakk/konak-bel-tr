...
$currentNews = $dbHandler->getActivitiesBySlug($page_slug);
...
$breadcrumbData = $breadcrumbClass->generateBreadcrumb("etkinlikler", "news");
...
$recentNews = $dbHandler->getRecentActivities($newsId, 3,1);
ob_start();
foreach ($recentNews as $haber) {
    ...
    echo '<div class="news-detail-right-capsule">
            <a href="/etkinlikler/' . htmlspecialchars($url_slug) . '">
                <div class="news-box">
                    <img src="/assets/images/activities/' . $haber['image'] . '" />
...
// Görünümü render et
include 'views/activities_detail.view.php';
