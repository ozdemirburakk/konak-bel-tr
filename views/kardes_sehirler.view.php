                ...
                <div class="inner-page-content">
                    <div class="inner-page-left">
                        <div class="kardes-sehir-inner">
                            <div class="kardes-sehir-seperator">
                                <div class="kardes-sehir-seperator-main">
                                    <span class="kardes-sehir-seperator-button" data-content="yurt-ici">YURT İÇİ</span>
                                </div>
                                <div class="kardes-sehir-seperator-main">
                                    <span class="kardes-sehir-seperator-button" data-content="yurt-disi">YURT DIŞI</span>
                                </div>
                            </div>
                            <div id="yurt-ici" class="content-section" style="display:none;">
                            ...
                            <div id="yurt-disi" class="content-section" style="display:none;">
                                <?php foreach ($kardes_sehirler_dis as $kardes) { ?>
