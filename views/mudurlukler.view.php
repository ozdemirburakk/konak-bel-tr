                        ...
                        <div>
                            <div class="mudurluk-page-capsule">
                                <?php foreach ($mudurlukler as $mudurluk) : ?>
                                    <a href="mudurlukler/<?= htmlspecialchars($mudurluk['url_slug']); ?>">
                                    <div class="mudurluk-box">
                                        <img src="/assets/icons/mudurlukler/<?= htmlspecialchars($mudurluk['icon']); ?>" />
                                        <div class="mudurluk-box-divider"></div>
                                        <strong><?= htmlspecialchars($mudurluk['adi']); ?></strong>
                                    </div>
                                    </a>
                                <?php endforeach; ?>
                            </div>
