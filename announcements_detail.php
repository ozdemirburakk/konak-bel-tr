...
$breadcrumbData = $breadcrumbClass->generateBreadcrumb("duyurular", "news");
...
$recentNews = $dbHandler->getRecentNews($newsId, 3, 2,1);
ob_start();
foreach ($recentNews as $haber) {
    ...
    echo '<div class="news-detail-right-capsule">
            <a href="/duyurular/' . htmlspecialchars($url_slug) . '">
                <div class="news-box">
...
// Görünümü render et
include 'views/announcements_detail.view.php';
