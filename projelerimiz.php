...
$page_name = "projelerimiz";


$dbHandler = new DBHandler($pdo);
$pvy_tamamlanan = $dbHandler->getProjelerimiz(1);
$ptyd_isler = $dbHandler->getProjelerimiz(2);
$pd_isler = $dbHandler->getProjelerimiz(3);
$p_isler = $dbHandler->getProjelerimiz(4);
...
include 'views/projelerimiz.view.php';